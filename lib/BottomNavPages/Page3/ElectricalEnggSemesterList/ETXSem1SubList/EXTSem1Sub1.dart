...
class EXTSem1Sub1 extends StatefulWidget {
  const EXTSem1Sub1({super.key, required this.title});
  final String title;
  @override
  State<EXTSem1Sub1> createState() => _EXTSem1Sub1();
}

class _EXTSem1Sub1 extends State<EXTSem1Sub1> {
  bool semester = false;
  @override
