...
class Semester2 extends StatefulWidget {
  const Semester2({Key? key,  required this.title}) : super(key: key);
  final String title;
  @override
    ...
    return Scaffold(
      appBar:AppBar(
        ...
        title:  Row(
          ...
          children: const [Text('Semester2          ',style: TextStyle(color: Colors.white, fontSize: 21, fontWeight: FontWeight.w500)),],
        ),
      ),
        body: ListView(
